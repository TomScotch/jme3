...
public class TestJoystick extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        /*
        try {
        try (PrintWriter out = new PrintWriter(new FileWriter("joysticks-" + System.currentTimeMillis() + ".txt"))) {
    ...
    protected void dumpJoysticks(Joystick[] joysticks, PrintWriter out) {
        for (Joystick j : joysticks) {
            ...
            j.getButtons().forEach((b) -> {
            out.println("   " + b);
            });
            
            out.println("  axes:" + j.getAxisCount());
            j.getAxes().forEach((axis) -> {
            out.println("   " + axis);
            });*/
        }
    }
    ...
    protected class ButtonView extends Node {
        ...
        private final ColorRGBA hilite = new ColorRGBA(0.0f, 0.75f, 0.75f, 0.5f);
