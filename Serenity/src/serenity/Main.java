...
public class Main extends SimpleApplication implements ScreenController, KeyInputHandler {
    ...
    private static boolean lightScatterEnabled = false;
    private static boolean anisotropyEnabled = false;
    private static boolean waterPostProcessing = true;
    private static boolean globalLightningEnabled = false;
    private static boolean isGl3 = false;
    ...
    public void switchShadows() {
        shadows = !isShadows();
        settingsNode.setUserData("shadows", isShadows());
        nifty.getScreen("settings").findNiftyControl("shadowsButton", Button.class).setText("Shadows : " + isShadows());
    }
    ...
    public void switchBloom() {
        ...
        settingsNode.setUserData("bloomEnabled", isBloomEnabled());
        nifty.getScreen("settings").findNiftyControl("BloomButton", Button.class).setText("Bloom : " + isBloomEnabled());
    }
    ...
    public void switchPostProcessWater() {
        waterPostProcessing = !isWaterPostProcessing();
        settingsNode.setUserData("waterPostProcessing", isWaterPostProcessing());
        nifty.getScreen("settings").findNiftyControl("waterButton", Button.class).setText("WaterPP = " + isWaterPostProcessing());
    }
    ...
    public void switchAnisotropy() {
        anisotropyEnabled = !isAnisotropyEnabled();
        settingsNode.setUserData("anisotropyEnabled", isAnisotropyEnabled());
        nifty.getScreen("settings").findNiftyControl("anisotropyButton", Button.class).setText("anisotropy = " + isAnisotropyEnabled());
    }
    ...
    public void switchLightScatter() {
        ...
        lightScatterEnabled = !isLightScatterEnabled();
        settingsNode.setUserData("lightScatterEnabled", isLightScatterEnabled());
        nifty.getScreen("settings").findNiftyControl("lightScatterButton", Button.class).setText("lightScatter = " + isLightScatterEnabled());
    }
    ...
    public void switchFog() {
        ...
        settingsNode.setUserData("fogEnabled", isFogEnabled());
        nifty.getScreen("settings").findNiftyControl("fogButton", Button.class).setText("fog = " + isFogEnabled());
    }
    ...
    public void switchGlobalLightning() {
        globalLightningEnabled = !isGlobalLightningEnabled();
        settingsNode.setUserData("globalLightningEnabled", isGlobalLightningEnabled());
        nifty.getScreen("settings").findNiftyControl("globalLightningButton", Button.class).setText("globalLightning = " + isGlobalLightningEnabled());
    }
    ...
    private final ActionListener actionListener = new ActionListener() {
        ...
        public void onAction(String name, boolean isPressed, float tpf) {
            ...
            if (stateManager.hasState(getGameRunningState())) {
                getGameRunningState().getPlayerCntrol().setIdleCounter(0);
            }
                ...
                layer(new LayerBuilder("Layer_ID") {
                    {
                        ...
                        panel(new PanelBuilder("panel_bottom") {

                            {
                                ...
                                control(new ButtonBuilder("BloomButton", "Bloom : " + isBloomEnabled()) {
                                    {
                                        align(ElementBuilder.Align.Right);
                                        height("5%");
                                        width("10%");
                                ...
                                control(new ButtonBuilder("globalLightningButton", "globalLighting = " + isGlobalLightningEnabled()) {
                                    {
                                        align(ElementBuilder.Align.Right);
                                        height("5%");
                                        width("10%");
                                ...
                                control(new ButtonBuilder("shadowsButton", "shadows = " + isShadows()) {
                                    {
                                        align(ElementBuilder.Align.Right);
                                        height("5%");
                                        width("10%");
                                ...
                                control(new ButtonBuilder("anisotropyButton", "Anisotropy = " + isAnisotropyEnabled()) {
                                    {
                                        align(ElementBuilder.Align.Right);
                                        height("5%");
                                        width("10%");
                                ...
                                control(new ButtonBuilder("waterButton", "WaterPP = " + isWaterPostProcessing()) {
                                    {
                                        align(ElementBuilder.Align.Right);
                                        height("5%");
                                        width("10%");
    ...
    /**
     * @return the lightScatterEnabled
     */
    public static boolean isLightScatterEnabled() {
        return lightScatterEnabled;
    }

    /**
     * @return the anisotropyEnabled
     */
    public static boolean isAnisotropyEnabled() {
        return anisotropyEnabled;
    }

    /**
     * @return the waterPostProcessing
     */
    public static boolean isWaterPostProcessing() {
        return waterPostProcessing;
    }

    /**
     * @return the globalLightningEnabled
     */
    public static boolean isGlobalLightningEnabled() {
        return globalLightningEnabled;
    }
